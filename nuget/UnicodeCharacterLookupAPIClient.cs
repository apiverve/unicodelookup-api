...
namespace APIVerve.API.UnicodeCharacterLookup
{
    ...
    /// <summary>
    /// Client for the UnicodeCharacterLookup API
    /// </summary>
    public class UnicodeCharacterLookupAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/unicodelookup";
        ...
        {
            { "character", new ValidationRule { Type = "string", Required = false } },
            { "codepoint", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public UnicodeCharacterLookupAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public UnicodeCharacterLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public UnicodeCharacterLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, UnicodeCharacterLookupQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(UnicodeCharacterLookupQueryOptions options)
        {
        ...
        public ResponseObj Execute(UnicodeCharacterLookupQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(UnicodeCharacterLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(UnicodeCharacterLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(UnicodeCharacterLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(UnicodeCharacterLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(UnicodeCharacterLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(UnicodeCharacterLookupQueryOptions options)
        {
