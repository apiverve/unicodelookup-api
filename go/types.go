// Package unicodelookup provides a Go client for the Unicode Character Lookup API.
//
// For more information, visit: https://apiverve.com/marketplace/unicodelookup?utm_source=go&utm_medium=readme
package unicodelookup
...
// Request contains the parameters for the Unicode Character Lookup API.
//
// Parameters:
//   - character: string - The Unicode character to lookup
//   - codepoint: string - The Unicode codepoint in hex (e.g., '1F44B' or 'U+1F44B')
type Request struct {
	Character string `json:"character,omitempty"` // Optional
	Codepoint string `json:"codepoint,omitempty"` // Optional
}
...
// ResponseData contains the data returned by the Unicode Character Lookup API.
