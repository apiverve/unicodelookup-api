# Unicode Character Lookup Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:unicodelookup-api:1.1.12'
}
```
...
```java
import com.apiverve.unicodelookup.UnicodeCharacterLookupAPIClient;
import com.apiverve.unicodelookup.APIResponse;
import com.apiverve.unicodelookup.APIException;

// Initialize the client
UnicodeCharacterLookupAPIClient client = new UnicodeCharacterLookupAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/unicodelookup](https://docs.apiverve.com/ref/unicodelookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/unicodelookup](https://docs.apiverve.com/ref/unicodelookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/unicodelookup-api/issues)
