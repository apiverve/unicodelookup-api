...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/unicodelookup',
        'Source': 'https://github.com/apiverve/unicodelookup-api',
        'Bug Tracker': 'https://github.com/apiverve/unicodelookup-api/issues'
    },
    classifiers=[
