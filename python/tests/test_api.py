...
class TestUnicodelookupAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = UnicodelookupAPIClient(self.api_key)

    @patch('apiverve_unicodecharacterlookup.apiClient.requests.get')
