...
{
    class UnicodeCharacterLookupExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/unicodelookup";

        /// <summary>
        /// Make a GET request to the Unicode Character Lookup API
        /// </summary>
        static async Task<JsonDocument> CallUnicodeCharacterLookupAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;character&quot;] &#x3D; &quot;👋&quot;, [&quot;codepoint&quot;] &#x3D; &quot;1F44B&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Unicode Character Lookup API...\n");

            var result = await CallUnicodeCharacterLookupAPI();
