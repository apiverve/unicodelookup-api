# Unicode Character Lookup API - Examples

This folder contains example code for using the Unicode Character Lookup API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/unicodelookup',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/unicodelookup");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/unicodelookup](https://docs.apiverve.com/ref/unicodelookup)
